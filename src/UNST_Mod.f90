...
real(8) pi
real(8) gg, unstdt, dt2, unsttime, dtq, th, fita, dtrain
...
real(8), allocatable :: qin(:,:), qinu(:,:), qinv(:,:)
...
integer plantFN, plantDa, paddydam, drainarea, dsmesh

real(8) timmax
real(8), allocatable :: node_dx(:,:), node_dy(:,:), lkyokai_dx(:), lkyokai_dy(:)
integer lkout, lpout
